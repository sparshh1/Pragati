...
export const TOURS: Tour[] = [
  /* ---------------- Candidate ---------------- */
  {
    ...
    steps: [
      {
        placement: 'centre',
        title: 'This portal has one job',
        body: 'To stop you from training for work that does not exist. Everything you see here is built on what employers in your district are actually hiring for — not on brochures. Let us show you around. It takes about a minute.',
      ...
      },
      {
        ...
        body: 'This is the most important part of the page. We look at your profile and tell you the two or three things worth doing right now, in plain words. If you only read one thing on this dashboard, read this.',
      ...
      },
      {
        ...
        body: 'Out of every course you could join, this one scored highest for you. The score is out of 100. Tap "See all my matches" and you can open any course to see exactly why it scored what it did — every point, added and subtracted.',
      ...
      },
      {
        ...
        body: 'Nine sections, and they are in the order most people need them. Not sure where to go? "Recommended for you" and "My CV & Job-Fit Card" are the two most people use first.',
  ...
  /* ---------------- Enterprise ---------------- */
  {
    ...
    title: 'Welcome — your enterprise dashboard',
    subtitle: 'Five steps covering what this portal does for an employer.',
    steps: [
      {
        placement: 'centre',
        title: 'What this portal does for you',
        body: 'Two things a job board cannot. First, what you post here changes how many training seats your district opens next year. Second, candidates reach you through a paid trial on your own floor, so you hire people you have already watched work.',
        marathi: 'तुम्ही इथे नोंदवलेली मागणी जिल्ह्याच्या प्रशिक्षण जागा ठरवते.',
      },
      {
        target: 'stats',
        title: 'Where you stand today',
        body: 'Pools you can still join, candidates currently on trial, idle machine hours near you, and the trades where demand is running ahead of training supply.',
        placement: 'bottom',
      },
      {
        target: 'nav',
        title: 'Six services, one per mechanism',
        body: 'Post hiring demand, join a hiring pool, endorse or flag syllabus content, rent out idle machine time, certify workers you already employ, and file the payroll declaration that releases your subsidy.',
        placement: 'right',
      },
      {
        target: 'pipeline',
        title: 'Hiring pools',
        body: 'A twelve-person unit cannot justify a training batch alone. Several MSMEs co-sign one batch, each committing only the seats they will genuinely absorb, at a wage floor each names. The State carries the training cost.',
        placement: 'top',
      },
      {
        target: 'guide-launcher',
  ...
  /* ---------------- Departmental ---------------- */
  {
    id: 'gov-welcome',
    route: '/gov/console',
    title: 'Departmental portal — orientation',
    ...
    steps: [
      ...
      },
      {
        ...
        body: 'State-wide, a single district, or a single training centre. Nothing outside this scope is loaded into any console — a district officer literally cannot see another district’s records.',
        placement: 'bottom',
      },
      {
        target: 'nav',
      ...
      },
      {
        ...
        body: 'Alerts are raised by the engines, never entered by hand. Each declares the permission needed to close it — so an alert you cannot action is routed to the role that can, instead of sitting unattended.',
        placement: 'top',
      },
    ],
  },
...
/* ------------------------------------------------------------------ */
/*  Per-page guides — "what is this page for, and how do I use it"      */
/* ------------------------------------------------------------------ */
...
export const PAGE_GUIDES: PageGuide[] = [
  ...
  },
  {
    ...
    what: 'Whether a trade is actually growing or shrinking where you live — and which specific tasks inside it are disappearing.',
    ...
    steps: [
      ...
      'If your trade is shrinking, that is not a dead end — open Career Pathways for a short bridge into a growing one.',
    ],
  },
  {
    ...
    steps: [
      ...
      'The right-hand panel updates live — the level you would be certified at, the hours you would still need, and how much more you would likely earn.',
  ...
  },
  {
    ...
    tip: 'The State pays you ₹380–₹420 every day of the trial, whether or not you are hired at the end.',
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      'On a real phone call there is no menu to navigate — you just say what you need in full sentences.',
    ],
  ...
  },
  {
    ...
    steps: [
      ...
      'Tick the EPFO and GST boxes if they apply — both raise your weight substantially.',
  ...
  },
  {
    ...
    what: 'The single declaration that releases your subsidy — and keeps your hiring signals trusted.',
    steps: [
  ...
  },
  {
    ...
    steps: [
      ...
      'The Dying Task Watch at the bottom is task-level, not trade-level — that is where syllabus rot actually shows up.',
    ],
  },
  {
    route: '/gov/capacity',
    ...
    steps: [
      ...
      'Drag the sliders on the right to test lifting a constraint — watch which ceiling takes over as binding.',
  ...
  {
    route: '/gov/districts',
    what: 'Where demand and training supply diverge, by district and sector — and the skills nobody is teaching.',
    steps: [
  ...
  },
  {
    ...
    steps: [
      ...
      'The voice register is the other half — candidates are the only party with no incentive to misreport.',
    ],
  },
  {
    route: '/courses',
    ...
    steps: [
      'Use the sort control to order the list by whatever matters to you — demand growth, pay, duration or seats left.',
  ...
  },
  {
    ...
    steps: [
      ...
      'Every figure here has already passed the trust filter — these are not job-board posting counts.',
    ],
  },
];
